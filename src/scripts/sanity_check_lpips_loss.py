...
def main():
    ...
    print("="*60)
    lpips_model = get_lpips_model(net='vgg', use_gpu=(device == 'cuda'))
    ...
    if results:
        ...
        # Strategy: weight should be such that LPIPS loss contributes ~10-20% of total loss
        ...
        # Target: LPIPS contribution = 15% of total loss
        # lpips_weight * avg_lpips = 0.15 * (mse_weight * avg_mse + lpips_weight * avg_lpips)
        # Solving: lpips_weight = 0.15 * mse_weight * avg_mse / (0.85 * avg_lpips)
        
        mse_weight = 1.0  # Default MSE weight
        recommended_weight = 0.15 * mse_weight * avg_mse / (0.85 * avg_lpips)
        ...
        print(f"\nRationale:")
        print(f"  - We want LPIPS loss to contribute ~15% of total reconstruction loss")
