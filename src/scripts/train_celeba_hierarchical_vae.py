...
CONFIG = {
    ...
    "run_name": "celeba-hvae-kl0.000001-sobel0.03-adv0.001-perc0.77-lpips0.02-ep40",
    "seed": 42,
    "num_workers": 8,
}
...
def loss_function(recon_x, x, kl_losses, config, discriminator=None, facenet=None, lpips_model=None):
